...
const PlayerList: React.FC<PlayerListProps> = ({ 
  ...
  return (
    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      {/* Pannello Aggiunta Atleta (SPOSTATO IN ALTO PER ADMIN) */}
      {isAdmin && (
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <input 
                ...
                className="p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-red-500 font-bold text-sm" 
                required 
              />
            </div>
            <div className="flex flex-col gap-1">
              ...
              <select 
                ...
                className="p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-red-500 font-bold text-sm h-[46px]"
              >
